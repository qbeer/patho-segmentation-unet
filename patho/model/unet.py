...
class UNET(Module):
    ...
    def forward(self, x):
        ...
        # Up forward pass
        up_layer_4 = conv_transpose2d(1024, 512, 2)(layer5)
        ...
        up_layer_3 = conv_transpose2d(512, 256, 2)(up_layer_4)
        ...
        up_layer_2 = conv_transpose2d(256, 128, 2)(up_layer_3)
        ...
        up_layer_1 = conv_transpose2d(128, 64, 2)(up_layer_2)
