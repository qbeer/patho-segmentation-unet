...
class UNET(Module):
    def __init__(self, input_shape=(572, 572, 3)):
        ...
        self.uplayer_1_conv3 = Conv2d(64, 2, 1)
        # Layer 2
    ...
    def forward(self, x):
        ...
        up_layer_4 = ConvTranspose2d(1024, 512, 2, padding=1, dilation=2, output_padding=0)(up_layer_4)
        ...
        up_layer_3 = interpolate(up_layer_4, scale_factor=2, mode='bilinear', align_corners=True)
        up_layer_3 = ConvTranspose2d(512, 256, 2, padding=1, dilation=2, output_padding=0)(up_layer_3)
        ...
        up_layer_2 = interpolate(up_layer_3, scale_factor=2, mode='bilinear', align_corners=True)
        up_layer_2 = ConvTranspose2d(256, 128, 2, padding=1, dilation=2, output_padding=0)(up_layer_2)
        ...
        up_layer_1 = interpolate(up_layer_2, scale_factor=2, mode='bilinear', align_corners=True)
        up_layer_1 = ConvTranspose2d(128, 64, 2, padding=1, dilation=2, output_padding=0)(up_layer_1)
